...
const HomeAboutUs = () => {
  return (
    <div className="about__us-container">
      <div className="about__us-left-side">
        <div className="about__us-left-side-content">
          <div className="about__us-left-side-banner">
            <h1>About Us</h1>
            <svg
            ...
            <p>
              ...
              voluptate vero nostrum similique veniam, doloremque aliquid
              accusantium, nihil itaque cumque ipsum, impedit reprehenderit eos.
            </p>
          </div>
      ...
      <div className="about__us-right-side">
